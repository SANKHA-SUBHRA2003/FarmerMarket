            ...
            child: Column(
              ...
              children: [
                ...
                _buildSection('Professional Details', [
                  _buildTextField(
                      'Total Work Experience', 'Total Work Experience', true),
                  _buildTextField('Last drawn CTC - per annum',
                      'Last drawn CTC - per annum', true),
                ]),
                _buildSection('Work Experience', [
                  _buildTextField(
                      'Previous Company Name', 'Previous Company Name', true),
                  _buildTextField('Job Title', 'Job Title', true),
                  _buildTextField('Job Experience', 'Job Experience', true),
                  _buildDatePicker('Start Date', _workStartController, true),
                  _buildDatePicker('End Date', _workEndController, true),
                ]),
