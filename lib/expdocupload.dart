...
class _DocumentUploadPageState extends State<DocumentUploadPage> {
  ...
  // State variables to hold the selected file names for each field
  ...
  String _appointmentLetterFileName = 'No file selected';
  String _relievingLetterFileName = 'No file selected';
  String _payslip1FileName = 'No file selected';
  String _payslip2FileName = 'No file selected';
  String _payslip3FileName = 'No file selected';
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDocumentSection('Work Experience', [
                  _buildUploadField('Recent Employer - Appointment Letter',
                      _appointmentLetterFileName, (fileName) {
                    setState(() {
                      _appointmentLetterFileName = fileName;
                    });
                  }),
                  _buildUploadField('Recent Employer - Relieving Letter',
                      _relievingLetterFileName, (fileName) {
                    setState(() {
                      _relievingLetterFileName = fileName;
                    });
                  }),
                  _buildUploadField(
                      'Last 3 Months Payslip 1', _payslip1FileName, (fileName) {
                    setState(() {
                      _payslip1FileName = fileName;
                    });
                  }),
                  _buildUploadField(
                      'Last 3 Months Payslip 2', _payslip2FileName, (fileName) {
                    setState(() {
                      _payslip2FileName = fileName;
                    });
                  }),
                  _buildUploadField(
                      'Last 3 Months Payslip 3', _payslip3FileName, (fileName) {
                    setState(() {
                      _payslip3FileName = fileName;
                    });
                  }),
                ]),
                Row(
